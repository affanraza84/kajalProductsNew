...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-white">
      ...
      {/* 1. Base Minimal Grid */}
      <div className="absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#fce7f3_1px,transparent_1px),linear-gradient(to_bottom,#fce7f3_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(circle_at_50%_0%,#000_70%,transparent_100%)]" />

      {/* 2. Floating Animated Orbs for "Magic" */}
      <motion.div 
        animate={{ 
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
