    ...
    <section id="instructors">
      <div className="relative h-[40rem] overflow-hidden flex items-center justify-center">
        <WavyBackground className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center h-full">
          <h2 className="tex-2xl md:text-4xl lg:text-7xl text-pink-700 font-bold text-center mb-8">
            Our Visionary Leaders
          </h2>
          <p className="text-base md:text-lg text-black text-center mb-4">
            Meet the skilled experts who will guide you through a delightful
            culinary journey at our company.
          </p>
